...
public class TestRu {
    ...
    public static void playMediaPlayer(MediaPlayer mediaPlayer, User user) {
        authenticate(mediaPlayer, user);
        meanwhile("downloadMediaFile");
        meanwhile("com.kennedy.media.controlAudio");
        meanwhile("com.kennedy.media.showAnimation");
        meanwhile("userControl");
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        playMediaPlayer(new MediaPlayer(new Media("")), new User());
    }
    ...
    private static void authenticate(MediaPlayer mediaPlayer, User user) {
